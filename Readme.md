...
# Configuration Script – bgi_vm_001 - Rev. A

This **Configuration** script is designed for the **bgi_vm_001** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – bgi_vm_001 Rev. A

Este script de **Configuration** está diseñado para el modelo **bgi_vm_001** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
