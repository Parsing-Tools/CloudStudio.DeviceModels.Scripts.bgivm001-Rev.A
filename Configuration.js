...
function getEndpoints(deviceAddress, endpoints)
{
  ...
  endpoints.addEndpoint("1", "Appliance", endpointType.appliance);
  endpoints.addEndpoint("2", "Dimmer", endpointType.dimmer);
  endpoints.addEndpoint("3", "Active Power sensor", endpointType.activePowerSensor);
  endpoints.addEndpoint("4", "Reactive Power sensor", endpointType.reactivePowerSensor);
  endpoints.addEndpoint("5", "Apparent Power Sensor", endpointType.apparentPowerSensor);
  endpoints.addEndpoint("6", "Camera", endpointType.camera);
  endpoints.addEndpoint("7", "Cos", endpointType.cosPhiSensor);
  endpoints.addEndpoint("8", "Current", endpointType.currentSensor);
  endpoints.addEndpoint("9", "Curtain", endpointType.curtainController);
  endpoints.addEndpoint("10", "Energy", endpointType.energyMeter);
  endpoints.addEndpoint("11", "Flow", endpointType.flowSensor);
  var gfs = endpoints.addEndpoint("12", "GenFlowSen", endpointType.genericFlowSensor);
  gfs.variableTypeId = 1107;
  var gs = endpoints.addEndpoint("13", "GenTar", endpointType.genericSensor);
  gs.variableTypeId=1125;
  endpoints.addEndpoint("14", "People Counter", endpointType.peopleCounter);
  endpoints.addEndpoint("15", "People Flow Sensor", endpointType.peopleFlowSensor);
  endpoints.addEndpoint("16", "Reactive Power sensor", endpointType.reactivePowerSensor);
  endpoints.addEndpoint("17", "Runtime Meter", endpointType.runTimeMeter);
  endpoints.addEndpoint("18", "ControladorCortinaNuevo", endpointType.curtainController);
